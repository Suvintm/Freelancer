// AdminLogin.jsx - Premium dark admin login page
...
const AdminLogin = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050509] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="bg-[#111319]/80 backdrop-blur-xl border border-[#262A3B] rounded-3xl p-8 shadow-2xl">
          {/* Header */}
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[#0a0a0e] border border-[#262A3B] rounded-xl px-12 py-3.5 text-white placeholder-gray-600 focus:outline-none focus:border-purple-500 transition-colors disabled:opacity-50"
                />
              </div>
            </div>
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading || lockoutMinutes}
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-4 rounded-xl transition-all flex items-center justify-center gap-3 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
                ...
                <span>Locked ({lockoutMinutes}m)</span>
              ) : (
                <>
                  <FaLock />
          ...
          {/* Security Notice */}
          <div className="mt-8 pt-6 border-t border-[#262A3B]">
