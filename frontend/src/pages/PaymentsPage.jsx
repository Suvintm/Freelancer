        ...
        <div className="max-w-4xl mx-auto px-4 py-4">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-bold light:text-slate-900">Payments & Refunds</h1>
              <p className="text-gray-400 light:text-slate-500 text-sm">
                {isEditor ? "Track your earnings" : "Manage your payments and wallet"}
              </p>
            </div>
          </div>
          ...
          {/* Tabs (Client Only) */}
          {!isEditor && (
            <div className="flex gap-6 border-b border-white/10 light:border-slate-200 -mb-4">
              <button
                onClick={() => setActiveTab("transactions")}
                className={`pb-4 text-sm font-medium transition-all relative ${
                  activeTab === "transactions"
                    ? "text-white light:text-slate-900"
                    : "text-gray-500 light:text-slate-500 hover:text-gray-300"
                }`}
              >
                Transactions
                {activeTab === "transactions" && (
