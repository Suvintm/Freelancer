        ...
        <>
            ...
            >
                ...
                <div>
                    ...
                    <p className="text-xs text-gray-500 light:text-slate-500">Welcome back, {user?.name || "User"}</p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    >
                        <HiBell className="text-lg text-gray-400 light:text-slate-600" />
                        {notificationBadge > 0 && (
                    ...
                    >
                        ...
                        <div className="hidden lg:block">
                            <p className="text-sm font-semibold text-white light:text-slate-900">{user?.name || "User"}</p>
                            <p className="text-[10px] text-gray-500 light:text-slate-500">Editor</p>
                        </div>
                    </div>
                </div>
            </header>
