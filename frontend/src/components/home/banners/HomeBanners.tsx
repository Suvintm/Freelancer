...
// ─────────────────────────────────────────────────────────────
// 1. BANNER 1: Ecosystem (More Tools. More Creators. A Brighter Tomorrow.)
// ─────────────────────────────────────────────────────────────
export const BannerEcosystem: React.FC<{ isDarkMode: boolean }> = ({ isDarkMode }) => {
  ...
  return (
    <div className={`relative w-full h-full inset-0 overflow-hidden select-none transition-colors duration-300 ${
      ...
      <div 
        className={`absolute inset-0 z-10 pointer-events-none transition-colors duration-500 ${
          isDarkMode
            ...
            : 'bg-gradient-to-r from-white via-white/85 via-45% to-transparent'
        }`}
      />
      ...
      <div className="relative z-20 h-full w-full px-5 sm:px-8 lg:px-10 py-5 sm:py-6 lg:py-8 flex flex-col justify-between">
        <motion.div
          initial={{ opacity: 0, x: -18 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.45, ease: 'easeOut' }}
          className="max-w-[340px] sm:max-w-md lg:max-w-xl flex flex-col items-start space-y-2 sm:space-y-3"
        >
          {/* Eyebrow Label */}
          <div className="text-[9.5px] sm:text-[11px] font-extrabold tracking-[0.22em] text-zinc-500 dark:text-zinc-400 uppercase select-none">
          ...
          {/* Subtitle */}
          <p className={`text-[11px] sm:text-[12.5px] font-medium leading-relaxed line-clamp-2 max-w-xs sm:max-w-md ${
          ...
          <div className="flex items-center gap-2.5 pt-0.5 sm:pt-1">
            <button
              ...
              className={`h-8.5 sm:h-9 px-4 sm:px-5 rounded-full font-bold text-xs sm:text-[12.5px] flex items-center gap-1.5 shadow-sm hover:scale-105 active:scale-95 transition-all cursor-pointer ${
                isDarkMode
            ...
            <button
              ...
              className={`h-8.5 sm:h-9 px-3.5 sm:px-4 rounded-full font-bold text-xs sm:text-[12.5px] flex items-center gap-1.5 border shadow-xs transition-all hover:scale-105 active:scale-95 cursor-pointer ${
                isDarkMode
        ...
        <motion.div
          ...
          className="flex items-center gap-2 sm:gap-2.5 pt-3 flex-wrap"
        >
          {/* Stat 1: 1M+ Creators */}
