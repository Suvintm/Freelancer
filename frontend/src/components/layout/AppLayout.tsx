    ...
    <div className="h-screen w-full bg-page flex flex-col font-sans overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        <div className="flex-1 min-w-0 h-full flex flex-col relative lg:py-4 lg:px-2">
          ...
          */}
          <div className={`w-full h-full lg:rounded-[48px] border-b lg:border border-border-main shadow-xl dark:shadow-2xl flex flex-col relative overflow-hidden transition-colors duration-300 ${isNotificationsPage || isExplorePage || location.pathname === '/home' ? 'bg-black' : 'bg-container'}`}>
