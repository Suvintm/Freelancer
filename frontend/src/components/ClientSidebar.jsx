    ...
    <>
      ...
      >
        ...
        <div className="px-3 py-2 border-t border-white/10 light:border-slate-100">
          <div className="bg-white/5 light:bg-slate-50 p-3 rounded-lg border border-white/10 light:border-slate-200">
            <p className="text-[10px] text-gray-400 light:text-slate-500 font-bold uppercase tracking-wider mb-2">Quick Stats</p>
            <div className="flex justify-between text-[11px] text-gray-400 light:text-slate-600 font-medium">
              <span>Active: {newOrdersCount}</span>
              <span>Unread: {displayUnread}</span>
            </div>
          </div>
        </div>
