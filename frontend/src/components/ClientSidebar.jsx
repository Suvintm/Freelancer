...
const ClientSidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="flex items-center gap-3 px-6 py-4 border-b border-emerald-600/20 bg-[#050509]">
          <img
          ...
          <div>
            ...
            <p className="text-[11px] text-emerald-400/80">Client Workspace</p>
          </div>
          <button
            onClick={onClose}
            ...
            return (
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-3 flex-1">
                  <Icon
                    className={`text-base ${
                      isActive ? "text-emerald-400" : "text-[#6B7280]"
                    }`}
                  />
                  <span>{label}</span>
        ...
        {/* Quick Stats */}
        <div className="px-4 py-3 border-t border-[#111827]">
          <div className="bg-gradient-to-r from-emerald-500/10 to-transparent p-3 rounded-xl border border-emerald-500/20">
            <p className="text-xs text-emerald-400 font-medium mb-1">Quick Stats</p>
