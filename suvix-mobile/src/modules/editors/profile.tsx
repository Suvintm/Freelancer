  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        <Text style={styles.title}>Editor Profile</Text>
        <Text style={styles.subtitle}>Showcase your editing skills and projects.</Text>
      </View>
      
      <View style={styles.placeholder}>
        <Text style={styles.placeholderText}>Portfolio & Skills Management coming soon...</Text>
      </View>
    </ScrollView>
  );
}
