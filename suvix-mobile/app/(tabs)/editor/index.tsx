    ...
    <ScreenContainer>
      ...
      >
        ...
        >
            ...
            <UnifiedBanner pageName="editors" />
        ...
        {/* Lower Dashboard Content (Normal swiping) */}
        <View style={styles.dashboardContainer}>
            ...
            <View style={[styles.infoCard, { backgroundColor: palette.secondary, borderColor: palette.border }]}>
                <Text style={[styles.infoTxt, { color: palette.textSecondary }]}>
                    We are building your personalized experience. Use the sidebar to manage your jobs and profile.
                </Text>
            </View>
            </View>
        </View>
