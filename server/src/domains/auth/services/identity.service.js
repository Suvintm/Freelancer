...
export const formatAuthResponse = (user, subscription = null) => {
  ...
  return {
    ...
    location_country: user.profile?.location_country || null,
    country: user.profile?.location_country || null,
    location_city: user.profile?.location_city || null,
    location_state: user.profile?.location_state || null,
    preferred_currency: user.profile?.preferred_currency || (user.profile?.location_country === "India" || user.profile?.location_country === "IN" ? "INR" : "USD"),
    preferredCurrency: user.profile?.preferred_currency || (user.profile?.location_country === "India" || user.profile?.location_country === "IN" ? "INR" : "USD"),
    mother_tongue: user.profile?.mother_tongue || null,
