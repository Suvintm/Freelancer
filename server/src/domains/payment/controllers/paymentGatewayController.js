...
export const getPaymentConfig = async (req, res) => {
  try {
    const user = req.user;
    const support = await paymentAdapter.isPaymentSupported(user.country);
    const currencyInfo = paymentAdapter.getCurrencyInfo(user.country);
...
export const createPaymentOrder = async (req, res) => {
  try {
    ...
    // Calculate fees
    const feeInfo = await paymentAdapter.calculatePlatformFee(order.amount);
...
export const verifyPayment = async (req, res) => {
  try {
    ...
    */
    ...
    const { Message } = await import("../../messaging/models/Message.js");
    ...
    */

    // Notify editor now that payment is confirmed
    const notificationService = (await import('../../../domains/notification/services/notificationService.js')).default;
...
export const verifyPaymentCallback = async (req, res) => {
  try {
    ...
    */
    ...
    try {
      const MessageClass = (await import("../../messaging/models/Message.js")).Message || (await import("../../messaging/models/Message.js")).default;
